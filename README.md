...
**Anomaly Detection:** CloudWatch monitors CloudTrail logs for anomalies, such as:
                                                1. More than three failed login attempts.
                                                2. Unusual S3 object access between midnight and 4 AM.
...
**Clone the Repository**
              1. git clone https://github.com/JeevikeshOfficial/secure-file-vault.git
              2. cd secure-file-vault
